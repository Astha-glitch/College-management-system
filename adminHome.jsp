...
<div class="w3-container">
  <div class="w3-bar w3-black">
    ...
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">Add New Faculty</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo')">Registered Students</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'China')">Registered Faculty</button>
     <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo1')">All Student Result</button>
     <a href="index1.jsp" class="w3-bar-item w3-button tablink">Modify Student Details</a>
                    ...
                    <div class="card">  
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="AddNewFaculty.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="facultyid" class="col-md-4 col-form-label text-md-right">Faculty ID</label>
                                    <div class="col-md-6">
...
<div id="China" class="w3-container w3-border city" style="display:none">
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <hr class="new1">
<center><h5>All Right Reserved @ saket,nikki,astha</h5></center> 
  <hr class="new1">
<br>
</body>
</html>